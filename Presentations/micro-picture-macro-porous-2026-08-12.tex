...
\begin{itemize}
    \item Connects to Guo's work on molecular communication in porous media.
...
\begin{itemize}
    ...
    \item Light-defined high-$\phi$ regions can play the role of the solid matrix.
...
\vspace{0.4cm}
\textbf{Self-contained claim:} structured 2D BZ experiments are a microscope for the dynamics that would occur inside a 3D porous chemical reactor.
