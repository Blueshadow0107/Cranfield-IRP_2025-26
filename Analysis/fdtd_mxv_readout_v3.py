#!/usr/bin/env python3
"""
fdtd_mxv_readout_v3.py
========================
Acoustic MxV layer + nonlinear readout for classification.
Reduced-generation scaling test for the 3x3 classifier.
...
def main():
    ...
    plt.tight_layout()
    plt.savefig(fig_dir / f'mxv_readout_matrix_{N_PORTS}x{N_PORTS}_v3.png', dpi=150)
    print(f"\nSaved: {fig_dir / f'mxv_readout_matrix_{N_PORTS}x{N_PORTS}_v3.png'}")
    ...
    plt.tight_layout()
    plt.savefig(fig_dir / f'mxv_readout_field_{N_PORTS}x{N_PORTS}_v3.png', dpi=150)
    print(f"Saved: {fig_dir / f'mxv_readout_field_{N_PORTS}x{N_PORTS}_v3.png'}")
