...
Outputs: Analysis/figures/rd_mms.{png,json}
"""
...
CASE_NAMES = ['barkley_iso', 'barkley_tilted', 'oregonator_A']
...
def make_figure(results):
    ...
    ax.loglog(dxs, 3e-3 * dxs**2, 'k--', lw=0.8, label='slope 2 (expected)')
    ax.set_xlabel('DX'); ax.set_ylabel('u L2 error at t=20')
    ax.set_title('Spatial convergence (DT = 0.05 DX$^2$)')
