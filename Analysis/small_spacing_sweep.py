"""
small_spacing_sweep.py
Quick preview: test 6 period values, plot transmission spectra.
"""
import numpy as np
import matplotlib
matplotlib.use('Agg')
...
for idx, period in enumerate(PERIODS):
    ...
    n_eff = (0.5 * (C_COLD/C_HOT) + 0.5 * 1.0)
    f_bragg = C0 / (2 * n_eff * period)
...
plt.tight_layout()
plt.savefig('small_spacing_sweep.png', dpi=150)
print("Saved: small_spacing_sweep.png")
